//package org.virtuslab.iskra.test.example
//
...
//
//  val untypedBooks: UntypedDataFrame =
//    spark.read.options(Map("header" -> "true")).csv(dataFilePath) // UntypedDataFrame = sql.DataFrame
//  untypedBooks.show()
